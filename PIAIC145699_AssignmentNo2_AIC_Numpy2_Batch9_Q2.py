...
def function1():
    ...
    np.arange(1,13).reshape((6,2)) # Write your code here 
...
def function3():
    ...
    x = a[] 
    fiveTable = np.arange(5,1000,5)
    sevenTable= np.arange(7,1000,7)
    np.intersect1d(fiveTable, sevenTable)
...
def function8():
    ...
    x =np.ones((2,5), dtype=np.int32). dot(6) #write your code here
...
def function11():
    ...
    ans = ans = np.arange(0,10, dtype=np.float64)
    ans[1:10:2]=-1#write your code here 
...
def function12():
    ...
    a=np.repeat(arr,3)
    b=np.tile(arr,3)
    ans=np.concatenate((a,b),axis=0)#write your code here 
...
def function13():
    ...
    ans =np.intersect1d(arr[arr>5],arr[arr<10]) #write your code here 
...
def function17():
    ...
    a=np.mod(arr,3)==0
    b=np.mod(arr, 5)==0
    np.where(a&b,"YES", "NO")# Write Your Code HERE
